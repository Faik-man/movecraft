...
public class SoulStoneBlock extends Block {
	...
	public SoulStoneBlock(int id, int textureId, boolean isPowered) {
	...
	public void onNeighborBlockChange(World world, int x, int y, int z, int neighborId) {
		if (!isPowered && world.isBlockGettingPowered(x, y, z)) {
			world.setBlockWithNotify(x, y, z, mod_BaseMod.SoulStonePowered.blockID);
		} else if (isPowered && !world.isBlockGettingPowered(x, y, z)) {
			world.setBlockWithNotify(x, y, z, mod_BaseMod.SoulStoneIdle.blockID);
		}
	}
